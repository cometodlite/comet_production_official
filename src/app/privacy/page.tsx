  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-20">
      <FadeUp className="text-center mb-16">
        <p className="text-[#86868b] text-[11px] tracking-widest uppercase mb-4">LEGAL</p>
        <h1 className="text-3xl md:text-4xl font-black text-white mb-4 tracking-tight">
          개인정보처리방침
        </h1>
        <p className="text-[#86868b]/70 text-sm mb-1">시행일자: 2026년 5월 7일</p>
        <p className="text-[#86868b]/70 text-sm">최종 개정일: 2026년 5월 7일</p>
      </FadeUp>
      ...
      <StaggerContainer className="space-y-6">
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-white/10">
                  <th className="text-left text-[#86868b]/70 text-xs tracking-wider pb-2 pr-4 w-1/3">구분</th>
                  <th className="text-left text-[#86868b]/70 text-xs tracking-wider pb-2">처리 목적</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-white/5">
                {[
                  ...
                  <tr key={a}>
                    <td className="text-[#86868b] text-xs py-2.5 pr-4 align-top font-medium">{a}</td>
                    <td className="text-[#86868b]/80 text-xs py-2.5 leading-relaxed">{b}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <StaggerItem>
          <div className="glass-card p-7 border border-white/[0.08]">
            ...
            <p className="text-white/90 text-xs font-semibold tracking-wider mb-3">1) 지원 및 문의 과정에서 처리하는 항목</p>
            <table className="w-full text-sm mb-6">
              <thead>
                <tr className="border-b border-white/10">
                  <th className="text-left text-[#86868b]/70 text-xs tracking-wider pb-2 pr-4 w-1/3">구분</th>
                  <th className="text-left text-[#86868b]/70 text-xs tracking-wider pb-2">처리 항목</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-white/5">
                {[
            ...
            <p className="text-white/90 text-xs font-semibold tracking-wider mb-3">2) 구성원 또는 프로젝트 참여자 관리 항목</p>
            <table className="w-full text-sm mb-6">
              <thead>
                <tr className="border-b border-white/10">
                  <th className="text-left text-[#86868b]/70 text-xs tracking-wider pb-2 pr-4 w-1/3">구분</th>
            ...
            <p className="text-white/90 text-xs font-semibold tracking-wider mb-3">3) 민감정보 및 고유식별정보</p>
        ...
        <StaggerItem>
          <div className="glass-card p-7 border border-white/[0.08]">
            ...
            <table className="w-full text-sm mb-4">
              <thead>
                <tr className="border-b border-white/10">
                  <th className="text-left text-[#86868b]/70 text-xs tracking-wider pb-2 pr-4 w-1/2">구분</th>
                  <th className="text-left text-[#86868b]/70 text-xs tracking-wider pb-2">보유 기간</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-white/5">
                {[
                  ...
                  <tr key={a}>
                    <td className="text-[#86868b] text-xs py-2.5 pr-4 align-top font-medium">{a}</td>
                    <td className="text-[#86868b]/80 text-xs py-2.5">{b}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <StaggerItem>
          <div className="glass-card p-7 border border-white/[0.08]">
            ...
            <p className="text-white/90 text-xs font-semibold tracking-wider mb-2">1) 파기 절차</p>
            <p className="text-[#86868b]/80 text-xs leading-relaxed mb-4">
              이용자의 개인정보는 목적 달성 후 내부 방침 및 관계 법령에 따라 일정 기간 저장된 후 파기됩니다.
            </p>
            <p className="text-white/90 text-xs font-semibold tracking-wider mb-3">2) 파기 방법</p>
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-white/10">
                  <th className="text-left text-[#86868b]/70 text-xs tracking-wider pb-2 pr-4 w-1/3">형태</th>
                  <th className="text-left text-[#86868b]/70 text-xs tracking-wider pb-2">파기 방법</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-white/5">
                {[
                  ...
                  <tr key={a}>
                    <td className="text-[#86868b] text-xs py-2.5 pr-4 font-medium">{a}</td>
                    <td className="text-[#86868b]/80 text-xs py-2.5">{b}</td>
                  </tr>
                ))}
              </tbody>
          ...
          <div className="glass-card p-7 border border-white/[0.08]">
            ...
            <ol className="space-y-1.5">
              {[
                ...
                <li key={i} className="flex gap-2 text-[#86868b]/80 text-xs leading-relaxed">
        ...
        <StaggerItem>
          <div className="glass-card p-7 border border-white/[0.08]">
            ...
            <table className="w-full text-sm mb-4">
              <thead>
                <tr className="border-b border-white/10">
                  <th className="text-left text-[#86868b]/70 text-xs tracking-wider pb-2 pr-4 w-1/3">수탁자</th>
                  <th className="text-left text-[#86868b]/70 text-xs tracking-wider pb-2">위탁 업무</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-white/5">
                {[
        ...
        <StaggerItem>
          <div className="glass-card p-7 border border-white/[0.08]">
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-white/10">
                  <th className="text-left text-[#86868b]/70 text-xs tracking-wider pb-2 pr-3">이전받는 자</th>
                  <th className="text-left text-[#86868b]/70 text-xs tracking-wider pb-2 pr-3">이전 국가</th>
                  <th className="text-left text-[#86868b]/70 text-xs tracking-wider pb-2 pr-3">이전 항목</th>
                  <th className="text-left text-[#86868b]/70 text-xs tracking-wider pb-2">이전 목적</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-white/5">
                {[
                  ...
                  <tr key={a}>
                    ...
                    <td className="text-[#86868b]/80 text-xs py-2.5 pr-3">{b}</td>
                    <td className="text-[#86868b]/80 text-xs py-2.5 pr-3 leading-relaxed">{c}</td>
                    <td className="text-[#86868b]/80 text-xs py-2.5 leading-relaxed">{d}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <StaggerItem>
          <div className="glass-card p-7 border border-white/[0.08]">
            ...
            <p className="text-white/90 text-xs font-semibold tracking-wider mb-2">1) 사용 목적</p>
            <ol className="space-y-1 mb-4">
              {["접속 상태 유지", "이용자 환경 설정 저장", "서비스 이용 통계 분석", "비정상 이용 탐지", "서비스 개선"].map((item, i) => (
                <li key={i} className="flex gap-2 text-[#86868b]/80 text-xs">
                  <span className="text-indigo-400 shrink-0">{i + 1}.</span>
                  <span>{item}</span>
                </li>
              ))}
            </ol>
            <p className="text-white/90 text-xs font-semibold tracking-wider mb-2">2) 쿠키 거부 방법</p>
            <p className="text-[#86868b]/80 text-xs leading-relaxed">
            ...
            <table className="w-full text-sm mb-4">
              <tbody className="divide-y divide-white/5">
                {[
                  ...
                  <tr key={a}>
                    <td className="text-[#86868b] text-xs py-2.5 pr-4 font-medium w-1/3">{a}</td>
                    <td className="text-[#86868b]/80 text-xs py-2.5">{b}</td>
                  </tr>
                ))}
              </tbody>
        ...
        <StaggerItem>
          <div className="glass-card p-7 border border-white/[0.08]">
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-white/10">
                  <th className="text-left text-[#86868b]/70 text-xs tracking-wider pb-2 pr-4 w-1/2">기관</th>
                  <th className="text-left text-[#86868b]/70 text-xs tracking-wider pb-2">역할</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-white/5">
                {[
        ...
        <StaggerItem>
          <div className="glass-card p-7 border border-white/[0.08]">
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-white/10">
                  <th className="text-left text-[#86868b]/70 text-xs tracking-wider pb-2 pr-4 w-1/5">버전</th>
                  <th className="text-left text-[#86868b]/70 text-xs tracking-wider pb-2 pr-4 w-1/4">시행일</th>
                  <th className="text-left text-[#86868b]/70 text-xs tracking-wider pb-2">주요 내용</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td className="text-[#86868b] text-xs py-2.5 pr-4 font-medium">v1.0</td>
                  <td className="text-[#86868b]/80 text-xs py-2.5 pr-4">2026.05.07</td>
                  <td className="text-[#86868b]/80 text-xs py-2.5">개인정보처리방침 최초 제정</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <StaggerItem>
          <div className="glass-card p-6 border border-indigo-500/20 bg-gradient-to-br from-indigo-900/10 to-transparent text-center">
            <p className="text-[#86868b] text-sm font-medium">부칙</p>
            <p className="text-[#86868b]/60 text-xs mt-1">본 개인정보처리방침은 2026년 5월 7일부터 시행됩니다.</p>
          </div>
        </StaggerItem>
